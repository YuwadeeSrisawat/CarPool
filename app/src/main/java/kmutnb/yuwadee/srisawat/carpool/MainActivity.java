...
public class MainActivity extends AppCompatActivity {
    ...
    private String userString, passwordString,tableString = "Diver";
    ...
    private void checkPassengerUser() {
        try {
            ...
            if (passwordString.equals(strMyResult[2])) {
                ...
                MyErrorDialog objMyErrorDialog = new MyErrorDialog();
                objMyErrorDialog.errorDialog(MainActivity.this, "Password False", "Please Try Agains Password False");

            }

        } catch (Exception e) {
            MyErrorDialog objMyErrorDialog = new MyErrorDialog();
            objMyErrorDialog.errorDialog(MainActivity.this,"ไม่มี User คนนี้" , "ไม่มี " + userString + " ไม่มีในฐานข้อมูล Passenger");
        }
    ...
    private void checkUser() {
        try {
            ...
            MyErrorDialog objMyErrorDialog = new MyErrorDialog();
            objMyErrorDialog.errorDialog(MainActivity.this, "ไม่มี User นี่", "ไม่มี " + userString + "ในฐานข้อมูล Diver");
                ...
                for (int i = 0; i < objJsonArray.length(); i++) {
                    ...
                    switch (intTimes) {
                        case 0:
                            ...
                            String strID_office = object.getString("id_office");

                            objCarUserTABLE.addNewUserCar(strUser, strPassword, strName, strSurname, strCarID, strPicture, strID_office);
                        ...
                        case 2:
                            ...
                            objMapsTABLE.addValeToMap(strName, strSurname, strIcon, strLat, strLng, strDate);
    ...
    private void testAddData() {
        ...
        objMapsTABLE.addValeToMap("Name", "SerName", "Icon", "Lat", "Lng", "Date");
    }
