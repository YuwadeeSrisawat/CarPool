...
public class ShowLatLngActivity extends AppCompatActivity {
    ...
    private void checkValue() {
        ...
        try {
            ...
            Toast.makeText(ShowLatLngActivity.this,"Connot Update mySQL ?", Toast.LENGTH_SHORT).show();
        }
    ...
    private void SynMapValueToSQLite() {
        ...
        try {
            ...
            strJSON = objBufferedReader.toString();
        ...
        try {
            ...
            for (int i = 0; i < objJsonArray.length(); i++) {
                ...
                String strSurname = object.getString("Surnam");
